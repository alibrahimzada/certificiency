...
from api.controllers import user_controller, event_controller, certificate_controller, customer_controller, auth_controller, role_controller, application_controller
