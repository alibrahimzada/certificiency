...
class TestCustomer(unittest.TestCase):
    ...
    def test_get_all_customers(self):
        ...
        self.customer.insert_customer(self.data['customer_0'])
        self.customer.insert_customer(self.data['customer_1'])
    ...
    def test_get_customer(self):
        ...
        for key in self.data['customer_0']:
            ...
            self.assertAlmostEqual(self.data['customer_0'][key], api_response['data'][key])
